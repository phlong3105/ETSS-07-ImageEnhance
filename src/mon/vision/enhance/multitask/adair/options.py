...
parser.add_argument("--de_type",       nargs="+",  default=["denoise_15", "denoise_25", "denoise_50", "derain", "dehaze", "deblur", "enhance"], help="which type of degradations is training and testing for.")
...
parser.add_argument("--gopro_dir",     type=str,   default="data/Train/Deblur/",  help="where clean images of denoising saves.")
parser.add_argument("--enhance_dir",   type=str,   default="data/Train/Enhance/", help="where clean images of denoising saves.")
